...
Demonstrates reading JSON files from a directory in streaming mode.
New files added to the directory are automatically picked up and processed.

Real-world use cases:
- Log file processing (application logs, web logs)
- Data ingestion from file drops
- ETL pipelines with file-based input
- FBI CJIS: Processing case files as they arrive

Key concepts:
- Schema inference vs explicit schema
- maxFilesPerTrigger for rate limiting
- File source options (cleanSource, latestFirst)
