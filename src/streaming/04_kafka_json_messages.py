...
Demonstrates producing and consuming JSON messages with Kafka.
This is the most common pattern for real-time data pipelines.
...
from pyspark.sql.functions import (
    ...
    current_timestamp, window, count, avg
)
...
def demo_aggregations(parsed_df):
    ...
    aggregated_df = df_with_timestamp \
...
def main():
    ...
    try:
        ...
        print("      spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.0 \\")
